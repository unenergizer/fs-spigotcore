...
public class PersistentInventory extends AbstractDatabaseFeature<PersistentInventoryData> {

    private final List<Player> playerInventorySyncList = new CopyOnWriteArrayList<>();
