...
//    private final Experience experienceCalculator = new SkillExperience();
...
//                        player.sendMessage(ChatColor.YELLOW + "Level your skill to gain access to more furnaces.");
//                        CommonSounds.ACTION_FAILED.play(player);
