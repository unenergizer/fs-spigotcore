...
public class CitizenManager implements FeatureOptional, FeatureShutdown, LoadsConfig, Listener {
    ...
    public void onEnable(boolean manualEnable) {
        ...
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(SpigotCore.PLUGIN, this::setupCitizen, FeatureManager.FEATURE_TASK_START_DELAY);
    }
